...
## 2 为何选 DeepSeek（而非 OpenAI / Claude）
...
| React 前端 | `panes/AiFixPane.tsx` | AI Fix 状态容器；交互呈现见 [design/02 § 4](../design/02_interaction.md#4-ai-fix-流程仅错误时) |
...
键盘决策与面板状态见 [design/02 § 4](../design/02_interaction.md#4-ai-fix-流程仅错误时)。
...
### 10.2 内部 HTTP 协议类型（DeepSeek wire format）
