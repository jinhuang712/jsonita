...
//!
//! Spec ref: `design/overview.md` § 1 tray API · § 2 menu 结构 · § 3 macOS 跨平台
//! Mockup ref: `design/screens.md` § 3 菜单栏 tray（light/dark 对照）
//! Icon ref: `design/overview.md` § 3 menubar template
//!
