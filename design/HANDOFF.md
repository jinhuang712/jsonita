...
- 现状:[`spec/S01-runtime-lifecycle.md`](../spec/S01-runtime-lifecycle.md) 明说浮窗 show/hide 过渡类**前端尚未接**,token 是保留设计 —— 实现时才真正接上。
...
- Tauri:`tauri.conf.json` 窗口 `transparent: true` + macOS `NSVisualEffectView` vibrancy（见 [`S01-runtime-lifecycle.md`](../spec/S01-runtime-lifecycle.md)、[`R00-release-readiness.md`](../spec/platform/R00-release-readiness.md) 与 [`A04-packaging-details.md`](../spec/appendix/A04-packaging-details.md)）。
