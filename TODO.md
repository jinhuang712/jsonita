...
- 关闭条件：主窗口左上角展示低干扰的小 logo，并在 `design/screens.md`、`design/prototype/index.html` 和真实 app UI 中保持一致。
...
- 关闭条件：AI Fix requesting 状态提供居中的、更明显的 loading 反馈和克制动画，并在 `design/screens.md`、`design/prototype/index.html` 和真实 app UI 中保持一致。
